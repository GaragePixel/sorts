...
Here 34 compare functions, who returns 0, -1 or 1, 0 casted for false, 1 casted for true.
...
@since 2025-07-12
#end
Function Compare<T1,T2>:Int( x:T1,y:T2 ) 				Where T1 Implements INumeric And T2 Implements INumeric
	Return x<=>y
End
